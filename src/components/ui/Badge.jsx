const colorMap = {
  indigo: 'bg-white/10 text-[var(--color-text-primary)] ring-white/20',
  blue: 'bg-white/10 text-[var(--color-text-primary)] ring-white/20',
  ...
  gray: 'bg-[var(--color-subtle)] text-[var(--color-text-muted)] ring-1 ring-inset ring-[#444444]',
  purple: 'bg-white/10 text-[var(--color-text-primary)] ring-white/20',
};
